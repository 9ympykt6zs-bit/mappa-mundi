...
assert.match(runtimeSource, /navigateToGlobeHubDestination\(`learn:journey:\$\{action\.journeyId\}`\)/);
...
assert.match(indexSource, /id="globe-navigation-menu-button"/);
assert.match(indexSource, /id="globe-hub-continue"/);
assert.match(indexSource, /id="globe-hub-explore"/);
assert.match(indexSource, /id="globe-hub-connections"/);
assert.match(indexSource, /id="globe-hub-reconstruction"/);
assert.match(indexSource, /id="globe-hub-progress"/);
assert.doesNotMatch(indexSource, /id="globe-navigation-learning-options"/);
assert.doesNotMatch(indexSource, /id="globe-navigation-current-menu"/);
