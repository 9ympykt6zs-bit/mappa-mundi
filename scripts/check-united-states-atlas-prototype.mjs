...
assert.ok(runtimeSource.includes("openMentalMapChallenge({ unitedStatesRelationshipsOnly: true })"), "U.S. Connections must reuse the filtered Mental Map entry path.");
