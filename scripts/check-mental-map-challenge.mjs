...
assert.ok(markupSource.includes("maplibre-poc.css?v=20260826-globe-navigation-prototype-1"));
...
assert.ok(challengeUiSource.includes('evaluation.missingStateIds.length ? "is-missing" : ""'));
assert.ok(challengeUiSource.includes('evaluation.selectedInvalidStateIds.length ? "is-incorrect" : ""'));
assert.ok(cssSource.includes(".mental-map-result-line.is-missing"));
assert.ok(cssSource.includes("border-left-color: #e6a23c"));
assert.ok(cssSource.includes(".mental-map-result-line.is-incorrect"));
assert.ok(cssSource.includes("border-left-color: #d95151"));
