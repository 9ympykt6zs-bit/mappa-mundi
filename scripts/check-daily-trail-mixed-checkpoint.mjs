...
assert.ok(appEntrySource.includes("./src/maplibre-poc.js?v=20260720-compass-challenge-1"));
assert.ok(previewEntrySource.includes("src/maplibre-poc.js?v=20260720-compass-challenge-1"));
[
...
assert.ok(runtimeSource.includes("import(\"./maplibre/maplibre-activity-runner.js?v=20260720-compass-challenge-1\")"));
