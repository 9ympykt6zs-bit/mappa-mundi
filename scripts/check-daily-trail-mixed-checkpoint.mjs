...
assert.ok(appEntrySource.includes("./src/maplibre-poc.js?v=20260711-us-atlas-2c-1"));
assert.ok(previewEntrySource.includes("src/maplibre-poc.js?v=20260711-us-atlas-2c-1"));
[
...
assert.ok(runtimeSource.includes("import(\"./maplibre/maplibre-activity-runner.js?v=20260711-us-atlas-2c-1\")"));
