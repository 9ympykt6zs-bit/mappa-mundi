...
assert.ok(appEntrySource.includes("./src/maplibre-poc.js?v=20260720-mental-map-audio-1"));
assert.ok(previewEntrySource.includes("src/maplibre-poc.js?v=20260720-mental-map-audio-1"));
[
