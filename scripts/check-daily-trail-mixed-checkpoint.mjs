...
assert.ok(appEntrySource.includes("./src/maplibre-poc.js?v=20260708-attribution-credits"));
assert.ok(previewEntrySource.includes("src/maplibre-poc.js?v=20260708-attribution-credits"));
[
...
assert.ok(runtimeSource.includes("import(\"./maplibre/maplibre-activity-runner.js?v=20260708-attribution-control-off\")"));
