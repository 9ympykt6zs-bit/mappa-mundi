...
| 2C. Personal U.S. atlas learning state | Weeks 3-4 | Not started | Add learning-state presentation to the existing atlas prototype. | Learning a state in Daily Trail or Memory Trail visibly and permanently changes the atlas without altering geography or retrieval behavior. |
