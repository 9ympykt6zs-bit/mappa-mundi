...
- U.S. Connections directly assesses 17 international-border edges, 25 coast edges, 36 state/major-river edges, 13 state/Great-Lake edges, and 61 state/mountain-range edges from the trusted atlas. The 50 Census-region memberships remain available as Atlas and reporting metadata but are not learner-facing assessed concepts. The physical subset is limited to features already present in the scored U.S. physical curriculum; other atlas relationship types remain data-only unless another fixed question already assesses them.
